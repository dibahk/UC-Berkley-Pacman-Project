...
def cornersHeuristic(state, problem):
    ...
    for corner in unvisited:
        # setting heurestic to be the manhattan distance between two points
        # heurestic.append(manhattanDistance(position, corner))
        # setting heurestic to be the maze distance between two points
        heurestic.append(mazeDistance(position, corner,problem.startingGameState))
    return max(heurestic)
...
def foodHeuristic(state, problem):
    ...
    heurestic = [0]
    for food in foods:
        heurestic.append(mazeDistance(position,food,problem.startingGameState))
    return max(heurestic)
                ...
                while fringe.isEmpty() == False:
                    ...
                    if problem.isGoalState(current_state):
                        ...
                        for successor in problem.getSuccessors(current_state):
                            if (len(path+[successor[1]])<=depth) and (not successor[0] in visited):
